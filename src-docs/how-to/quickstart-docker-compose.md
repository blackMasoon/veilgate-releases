---
title: Quickstart – Docker + docker-compose
description: How to run a released Veilgate package using Docker and docker-compose.
---
...
- `docs/QUICKSTART.md` – this quickstart (bundled in the release).
